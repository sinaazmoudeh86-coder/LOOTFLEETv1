# LAUNCH — deploy-v215 · build 473

Stamps verified aligned: `version.json` **473** · `LF_BUILD` **473** · SW cache `lootfleet-v473`.
...
**MOVE SPEED CAP + HANG FIXES (473).** Move speed capped at +1000% (was reaching 3541%).
