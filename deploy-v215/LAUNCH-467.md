# LAUNCH — deploy-v215 · build 467

Stamps verified aligned: `version.json` **467** · `LF_BUILD` **467** · SW cache `lootfleet-v467`.
...
seconds later. 467 detects the mid-play death (no clean-exit marker), enters RECOVERY MODE
