...
(function () {
  ...
  const FEATURES = [
    ...
    {
      id: 'missions', sim: 'autobattle', acc: '#46d27a', cat: 'Daily engine', nav: 0, hudL: '\u2611 MISSIONS', hudV: '7/10', cap: '10 daily orders \u00b7 bonus crate',
      title: 'Ten missions a day, one fat crate',
      lead: 'Fleet Command issues ten fresh orders every day \u2014 kills, boss hunts, scavenging, patrols. Progress counts automatically while you fight, every order pays gold and resources, and clearing all ten drops the Commander\u2019s Crate: 100 LootCoins, free, daily.',
      mech: [['Ten fresh orders daily', 'Drawn from a wide pool and scaled to your level and zone depth.'], ['Progress counts itself', 'No tracking chores \u2014 fight normally and claim when bars fill.'], ['The Commander\u2019s Crate', 'Clear the board for 100 \u25c9 LootCoins plus a resource bundle, every day.']],
      stat: [['10', 'Orders / day'], ['100 \u25c9', 'All-clear bonus']],
    },
    {
      id: 'moon', sim: 'resources', acc: '#9ecfff', cat: 'Idle industry', nav: 1, hudL: '\ud83c\udf19 MOON COLONY', hudV: '24/7', cap: 'mines \u00b7 drones \u00b7 raids',
      title: 'Build a moon that pays you to sleep',
      lead: 'From Level 30 you claim a moon and build it out \u2014 ore mines, fuel wells, refineries, cargo drones, laser towers. It produces around the clock, even offline\u2026 as long as your defenses hold. Underdefended colonies get raided and knocked offline.',
      mech: [['Live colony diorama', 'Mining ships tractor-beam ore, drones ferry cargo, shuttles launch your shipments.'], ['Raids with teeth', 'Pirates hit every few hours \u2014 build towers or watch systems go dark until repaired.'], ['Five moons to claim', 'Fully terraform one moon to unlock the next, each biased toward a different resource.']],
      stat: [['5', 'Moons'], ['24/7', 'Production']],
    },
    {
      id: 'supply', sim: 'shop', acc: '#ffd24d', cat: 'Guaranteed drops', nav: 2, hudL: '\u25a3 GALAXY SUPPLY', hudV: '100%', cap: 'buy the tier you want',
      title: 'Crates that never roll a dud',
      lead: 'Galaxy Supply flips the loot economy: spend farmed resources on a crate of the exact rarity you want \u2014 every crate is a guaranteed drop at your current zone depth. The Cosmic Cache is the only source of Artifact-tier relics.',
      mech: [['Pick your tier', 'Rare to Cosmic, priced in the resources you already farm.'], ['Rolls at your depth', 'Push deeper first \u2014 crates scale to your current zone.'], ['The Cosmic Cache', 'A LootCoin cache holding the game\u2019s only Artifact relics.']],
      stat: [['100%', 'Drop rate'], ['Lv 30', 'Unlocks']],
    },
    {
      id: 'fleetrank', sim: 'citadel', acc: '#ff5168', cat: 'Endgame PvP', nav: 4, hudL: '\u2694 FLEET RANK', hudV: 'RAID', cap: 'raid rival citadels',
      title: 'Raid real players\u2019 citadels',
      lead: 'The Level-50 ladder: build a citadel, ring it with towers, hire mercenaries \u2014 then raid other operators\u2019 bases for spoils. The battle itself decides the outcome, so a well-flown underdog run can genuinely topple a stronger base.',
      mech: [['Honest battles', 'Your attack-to-defense ratio sets the difficulty; what happens on screen is the result.'], ['Defense earns too', 'Your towers and mercs guard your spoils while you\u2019re away.'], ['Climb the ranks', 'Win raids to rise through ten ranks toward the top of the ladder.']],
      stat: [['Lv 50', 'Unlocks'], ['PvP', 'Raids']],
    },
    {
      id: 'dreadhunt', sim: 'boss', acc: '#b87bff', cat: 'Weekly raid', nav: 0, hudL: '\u25c7 DREAD CORES', hudV: 'HUNT', cap: 'weekly boss \u2192 pilot tree',
      title: 'Hunt the Dreadnaught, keep the power',
      lead: 'A weekly raid boss stalks the deep zones. Bring it down for \u25c7 Dread Cores and spend them in the Pilot Tree \u2014 permanent, ship-agnostic bonuses that survive every refit, respec and hull evolution you\u2019ll ever make.',
      mech: [['Weekly spawn', 'One Dreadnaught per week; the first kill pays best.'], ['Dread Cores', 'The only currency the Pilot Tree accepts.'], ['Permanent gains', 'Pilot bonuses stick across every ship you\u2019ll ever fly.']],
      stat: [['1/wk', 'Spawn'], ['\u221e', 'Bonus duration']],
    },
    {
