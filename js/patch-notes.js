...
(function () {
  ...
  const NOTES = {
    build: 726,
    title: 'BUILD 726',
    sub: 'Ranks now shows only what pilots have actually published.',
    groups: [
      { k: 'FIXED', c: '#8fc4ff', rows: [
        ['\u27a4', 'The ships beside a pilot are their real ships', 'When a fleet had not reached the server, the board filled the gap with hulls generated from that pilot\u2019s NAME \u2014 so the strip beside a real person was not their fleet. Rows now show published hulls only. Most will look empty for a few hours and fill in as people log in; yours is always live.'],
        ['\u2756', 'Rival loadouts are no longer invented', 'Tapping a pilot showed a full six-slot fitting with names and rarities. The board has never carried anyone\u2019s gear, so all of it was generated. You keep their real rank, power, level and fleet \u2014 and the sheet now says plainly when a pilot has published nothing yet.'],
        ['\u2726', 'Your Command Rank row shows your officers', 'It printed your real Command Score above the words \u201cNo Commanders seated\u201d. It draws your actual line-up now.'],
        ['\u2691', 'Territory counts your citadels', 'The Territory board never received a citadel count from any real account, so the line under your name read systems only \u2014 however many fortresses you were holding. Your revenue ranking was always correct; the caption was not.'],
      ] },
    ],
  };
